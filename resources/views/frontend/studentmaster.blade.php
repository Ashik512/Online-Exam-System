  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('show-mark')}}" class="nav-link">Home</a>
      </li>
   ...
   <a href="{{route('student.logout')}}" class="ml-auto btn btn-primary">Logout</a>
  </nav>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('give-exam-form')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('show-mark')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Marks
           ...
           <li class="nav-item">
            <a href="{{route('mistakes')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Mistake List
